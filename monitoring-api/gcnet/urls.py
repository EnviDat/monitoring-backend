...
urlpatterns = [
    ...
    # Metadata
    path(
        "metadata/<str:model>/<str:parameters>/",
    ...
    # JSON
    path(
        "json/<str:model>/<str:parameters>/<str:start>/<str:end>/",
        get_json_data,
        {"app": "gcnet"},
    ),
    path(
    ...
    # NEAD
    path(
        "nead/<str:model>/<str:timestamp_meaning>/<str:nodata>/<str:start>/<str:end>/",
    ...
    path(
        "nead/<str:model>/<str:timestamp_meaning>/<str:nodata>/",
        streaming_csv_view_v1,
        {"app": "gcnet"},
    ),
    path(
    ...
    # CSV
    path(
        "csv/<str:model>/<str:parameters>/<str:timestamp_meaning>/<str:nodata>/<str:start>/<str:end>/",
        generic_get_data,
        {
            "app": "gcnet",
            "model_validator": get_model,
    ...
    path(
        "csv/<str:model>/<str:parameters>/<str:timestamp_meaning>/<str:nodata>/",
        generic_get_data,
        {
            "app": "gcnet",
            "model_validator": get_model,
    ...
    # Daily JSON
    path(
        "summary/daily/json/<str:model>/<str:parameters>/<str:start>/<str:end>/",
    ...
    # Daily CSV
    path(
        "summary/daily/csv/<str:model>/<str:parameters>/<str:timestamp_meaning>/<str:nodata>/<str:start>/<str:end>/",
        generic_get_daily_data,
        {
            "app": "gcnet",
            "model_validator": get_model,
