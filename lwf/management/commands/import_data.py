# WARNING this script must still be adapted for LWF station data!!!!!!
...
logging.basicConfig(filename=Path('lwf/logs/import_data.log'), format='%(asctime)s   %(filename)s: %(message)s',
                    datefmt='%d-%b-%y %H:%M:%S')
...
class Command(BaseCommand):
    ...
    def is_nead_source(self, inputfile):
        ...
        for first_line in source:
            # TODO get rid of second part of statement?
