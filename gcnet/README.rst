...
Parameters used in API call::
   ...
   airtemp2_maximum     Max Air Temperature2 (TC)[degC]
   airtemp1_minimum     Min Air Temperature1 (TC)[degC]
   airtemp2_minimum     Min Air Temperature2 (TC) [degC]
   windspeed_u1_maximum Max Windspeed-U1 [m/s]
   windspeed_u2_maximum Max Windspeed-U2 [m/s]
